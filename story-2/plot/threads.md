...
| Ý nghĩa ẩn trong câu nói của Arik "giờ thì ta đã hiểu vì sao ông ấy xin rời xa mọi người" | 4 | Mở (dài hơi — liên quan `plot/secrets/bi-mat-chien-tranh-bien-thuy.md`) | 10 trong arc này (gợi ý thêm); trả trọn ở arc sau của skeleton | Ronan ghi nhớ câu nói nhưng chưa đủ tỉnh táo để suy luận ý nghĩa |
| Giáo Hội để mắt tới Ronan | 5 | Mở (dài hơi, leo thang ở ch9 — thư chính thức đòi giao nộp, bị Arik từ chối) | 12 (Dreven đích thân xuất hiện) | Tư tế trẻ ghi chép hình phạt → Giáo Hội gửi thư chính thức đòi giao nộp Ronan |
...
| Cảnh báo dang dở của Rodrick về căn nhà | 10 | Mở (dài hơi — liên quan `plot/secrets/bi-mat-chien-tranh-bien-thuy.md`) | Arc 4 của skeleton (Ronan tìm thấy cuốn sổ) | "Đừng bao giờ cho ai sửa sàn căn nhà" — chưa rõ ý nghĩa |
| Quan hệ Ronan-Isolde chớm thành thật | 7 | Mở (tiến triển rõ rệt ở ch8) | 11 (tiến triển thêm) | Hai người kể chuyện đời mình cho nhau; Isolde tặng sách dạy đọc chữ bất chấp lệnh cấm của cha |
| Isolde bất chấp lệnh cấm của cha để gặp Ronan | 8 | Mở | (chưa xác định) | Arik đã biết và cấm tuyệt đối, nhưng Isolde vẫn tiếp tục |
| Áp lực Vercast đòi Isolde làm "khách quý" | 8 | Mở | 9, 11 | Tể tướng Corvin gửi thư nhân danh vua; Arik chỉ có thể trì hoãn |
