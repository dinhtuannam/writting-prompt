...
|---|---|---|---|
| Corin | Nhân vật chính — lính nghĩa vụ, người cầm Thánh Kiếm Dawn (từ Ch.2) | Còn sống | `corin.md` |
| Bregan | Phụ — đội trưởng của Corin tại Cindergate | Đã chết (Ch.2) | `bregan.md` |
| Maren | Phụ quan trọng (Arc 1) — nữ cứu thương/đầu bếp, mối dây người của Corin | Còn sống (trốn hầm kho) | `maren.md` |
| Aldous | Phụ — Hộ Vệ hộ tống thanh kiếm-quân-kỳ | Đã chết (Ch.2) | `aldous.md` |
...
| Holt | Phụ nhỏ — đầu nhóm lính đào ngũ Corin gặp Ch.13 (quê hạt Oakmere, xẻo mất một tai) | Còn sống (Ch.13) | (chưa có) |
| Pip | Phụ nhỏ — cháu Holt, ít tuổi hơn Corin | Còn sống (Ch.13) | (chưa có) |
